...
describe "#translate" do
  ...
  it "retains capitalization if word is capitalized" do
    #See here? I added my own test for words where the only vowel is a "y" and it passes!
    s = translate("My name is Kate")
    s.should == "Ymay amenay isay Atekay"
  end

  # * retain the punctuation from the original phrase
  it "retains punctuation" do
    s = translate("Hello, you're awfully cute, Cat.")
    s.should == "Ellohay, ou'reyay awfullyay utecay, Atcay."
  end
